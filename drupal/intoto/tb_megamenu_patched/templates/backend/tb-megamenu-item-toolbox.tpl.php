<div id="tb-megamenu-admin-mm-toolitem" class="admin-toolbox">
  ...
  <ul>
    <li title="<?php print t('Icon') . ' - ' . t('Add Icon for Menu Item. Click Icon label to visit Bootstrap icons page and get Icon Class. E.g.: fa fa-search') ?>">
      <label class="hasTip">
        <a href="http://twitter.github.com/bootstrap/base-css.html#icons" target="_blank"><i class="fa fa-search"></i><?php print t('Icon') ?></a>
      </label>
      <fieldset class="">
